...
function numberToWords(number) {
    let numberText = "";
    let value = Math.floor(parseFloat(number));
    if (value === 0)
        numberText = "CERO";
    else if (value === 1)
        numberText = "UNO";
        ...
        if (value - Math.floor(value / 1000000) * 1000000 > 0)
            numberText =
                numberText +
                    " " +
                    numberToWords((Math.floor(value) - Math.floor(value / 1000000) * 1000000).toString());
    }
    else if (value == 1000000000000)
        numberText = "UN BILLON";
    else if (value < 2000000000000)
        numberText =
            "UN BILLON " +
                numberToWords((Math.floor(value) -
                    Math.floor(value / 1000000000000) * 1000000000000).toString());
    else {
        numberText =
